...
public class NewMatchDtoValidator implements Validator<NewMatchDto> {

    private static final NewMatchDtoValidator INSTANCE = new NewMatchDtoValidator();

    private final PlayerDtoValidator playerDtoValidator;

    private NewMatchDtoValidator() {
        playerDtoValidator = PlayerDtoValidator.getInstance();
    }

    public static NewMatchDtoValidator getInstance(){
        return INSTANCE;
    }
     ...
     */
    @Override
    public ValidationResult isValid(NewMatchDto newMatchDto) {
