...
public class MatchScoreController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ActiveMatch activeMatch = ongoingMatchesService.getActiveMatch(UUID.fromString(uuidString)).orElseThrow(() -> new RuntimeException("Матча с таким uuid не существует"));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String uuidString = req.getParameter("uuid");
        ActiveMatch activeMatch = ongoingMatchesService.getActiveMatch(UUID.fromString(uuidString)).get();
